...
cmovTk:          irmovl $1, %eax
                 irmovl $2, %ebx
                 xorl   %ecx, %ecx
                 cmove  %eax, %ebx        # ebx should be changed
                 addl   %ebx, %ebx        # ebx should be 1 + 1 == 2
                 halt

.pos 0xa00
cmovNotTk:       irmovl $1, %eax
                 irmovl $2, %ebx
                 xorl   %ecx, %ecx
                 cmovne %eax, %ebx        # ebx should not be changed
                 addl   %ebx, %ebx        # ebx should be 2 + 2 == 4
                 halt
